    ...
    return (
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div className="navbar-center"> <a href="#" onClick={(e) => handlePlantsClick(e)} style={styleA}>Plants</a></div>
            ...
            {!showCart ? (
                <div className="product-grid">
                    ...
                    <div key={index}> {/* Unique key for each category div */}
                        <h1 className="plantname_heading plant_heading">
